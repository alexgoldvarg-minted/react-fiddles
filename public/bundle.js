...
/***/ function(module, exports, __webpack_require__) {
	...
	var PrimaryNav = (function (_React$Component3) {
	  _inherits(PrimaryNav, _React$Component3);

	  function PrimaryNav(props) {
	    _classCallCheck(this, PrimaryNav);

	    _get(Object.getPrototypeOf(PrimaryNav.prototype), 'constructor', this).call(this, props);

	    this.state = {
	      data: [{ id: 1, name: 'aaa' }, { id: 2, name: 'bbb' }, { id: 3, name: 'ccc' }, { id: 4, name: 'ddd' }]
	    };
	  }
	  ...
	  _createClass(PrimaryNav, [{
	    key: 'render',
	    value: function render() {
	      var primaryNavNodes = this.state.data.map(function (node) {
	        return _react2['default'].createElement(PrimaryNavNode, { name: node.name, key: node.id });
	      });
	...
	var PrimaryNavNode = (function (_React$Component4) {
	  _inherits(PrimaryNavNode, _React$Component4);

	  function PrimaryNavNode(props) {
	    _classCallCheck(this, PrimaryNavNode);

	    _get(Object.getPrototypeOf(PrimaryNavNode.prototype), 'constructor', this).call(this, props);
	  ...
	  return PrimaryNavNode;
	})(_react2['default'].Component);

	exports.PrimaryNavNode = PrimaryNavNode;

	_reactDom2['default'].render(_react2['default'].createElement(Main, null), document.getElementById('app-container'));
